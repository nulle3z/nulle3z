...
<table>
    <tr>
        <td><strong>Favorite tools</strong></td><td><strong>Operating System</strong></td><td><strong>Machine</strong></td>
    </tr>
    <tr>
        <td><p>Editor:</p>
            <ul>
            ...
            <ul>
                <li>C</li>
                <li>Python (Starting from 3.11.4)</li>
            </ul>
        </td>
        <td>
            <ul>
                <li>Windows 10 (Refuse Win-11)</li>
                <li>Any GNU/Linux distribution (commonly used: RHEL, Debian, Gentoo)</li>
            </ul>
        </td>
        <td>
            <ul>
                <li>Panasonic CF-33 laptop</li>
                <li>DELL PowerEdge R430 Server</li>
            </ul>
        </td>
    </tr>
</table>
